...
- [in-progress] **11.6** **HTTP routes** (Slice 5): `GET/POST/PATCH /api/tenants`; `withTenant` applied to `/api/goals`, `/api/sessions`, `/api/sessions/:id/turns`, `/respond`. HTTP integration tests incl. 403 cross-tenant.
